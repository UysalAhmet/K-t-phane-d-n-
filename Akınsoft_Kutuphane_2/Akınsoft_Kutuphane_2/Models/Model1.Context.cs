...
namespace Akınsoft_Kutuphane_2.Models
{
    ...
    public partial class Akinsoft_KutuphaneEntities : DbContext
    {
        public Akinsoft_KutuphaneEntities()
            : base("name=Akinsoft_KutuphaneEntities")
        {
        }
        ...
        public virtual DbSet<OduncTeslim> OduncTeslim { get; set; }
